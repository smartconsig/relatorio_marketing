...
| Etapa B1 | Virada: fichas viram a fonte de leitura; snapshot vira reserva (fallback se contagem não bater) e continua sendo gravado | ✅ produção 07/09/2026 — conferência aprovada (40 comparações, todas OK; 7.479 fichas = contagem esperada; 1 import_id) |
