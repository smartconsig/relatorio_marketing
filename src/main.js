...
import { renderLiberacao, libAddCliente, libFecharModal, libCalcPreview, libSalvarCliente, libToggleOk, libSalvarAcerto, libSetSearch, libSetPreset, libClearDate, libSetDateManual, libVerMais, libImportarPlanilha, libOnImportFile, libImportarAcerto, libOnImportAcertoFile, libDeletarCliente, libLimparBase, libExportar, libEditarCliente, libSalvarEdicao, libSetEmpresaFiltro } from './pages/liberacao-page.js';
import { renderBoletos, bolSetSearch, bolSetPreset, bolClearDate, bolSetDateManual, bolVerMais, bolSetEmpresaFiltro, bolSetStatusFiltro, bolImportarPlanilha, bolOnImportFile, bolAddCliente, bolSalvarCliente, bolEditarCliente, bolSalvarEdicao, bolFecharModal, bolDeletarCliente, bolLimparBase, bolExportar, bolMudarStatus, bolMarcarQuitado, bolAbrirReprovar, bolConfirmarReprovar, bolVerMotivo, bolParaResiduo } from './pages/boletos-page.js';
import { renderResiduos, resSetSearch, resSetStatusFiltro, resVerMais, resPopShow, resPopEnter, resPopLeave, resVerDoc, resBaixarDoc, resExcluirDoc, resAbrirAnexo, resOnAnexoFile, resAnexarComo, resMarcarPago, resConfirmarPago, resFecharModal, resExcluir, resAbrirImport, resOnZipFile, resAtribuirOrfao, resConfirmarImport } from './pages/residuos-page.js';
...
window.setFunilView           = setFunilView;
window.toggleFunilAndamento   = toggleFunilAndamento;
window.exportRankingPDF       = exportRankingPDF;
...
window.libImportarAcerto      = libImportarAcerto;
window.libOnImportAcertoFile  = libOnImportAcertoFile;
...
window.libSetEmpresaFiltro = libSetEmpresaFiltro;
window.bolSetSearch        = bolSetSearch;
window.bolSetPreset        = bolSetPreset;
window.bolClearDate        = bolClearDate;
window.bolSetDateManual    = bolSetDateManual;
window.bolVerMais          = bolVerMais;
window.bolSetEmpresaFiltro = bolSetEmpresaFiltro;
window.bolSetStatusFiltro  = bolSetStatusFiltro;
window.bolImportarPlanilha = bolImportarPlanilha;
window.bolOnImportFile     = bolOnImportFile;
window.bolAddCliente       = bolAddCliente;
window.bolSalvarCliente    = bolSalvarCliente;
window.bolEditarCliente    = bolEditarCliente;
window.bolSalvarEdicao     = bolSalvarEdicao;
window.bolFecharModal      = bolFecharModal;
window.bolDeletarCliente   = bolDeletarCliente;
window.bolLimparBase       = bolLimparBase;
window.bolExportar         = bolExportar;
window.bolMudarStatus      = bolMudarStatus;
window.bolMarcarQuitado    = bolMarcarQuitado;
window.bolAbrirReprovar    = bolAbrirReprovar;
window.bolConfirmarReprovar = bolConfirmarReprovar;
window.bolVerMotivo        = bolVerMotivo;
window.bolParaResiduo      = bolParaResiduo;
window.resSetSearch        = resSetSearch;
window.resSetStatusFiltro  = resSetStatusFiltro;
window.resVerMais          = resVerMais;
window.resPopShow          = resPopShow;
window.resPopEnter         = resPopEnter;
window.resPopLeave         = resPopLeave;
window.resVerDoc           = resVerDoc;
window.resBaixarDoc        = resBaixarDoc;
window.resExcluirDoc       = resExcluirDoc;
window.resAbrirAnexo       = resAbrirAnexo;
window.resOnAnexoFile      = resOnAnexoFile;
window.resAnexarComo       = resAnexarComo;
window.resMarcarPago       = resMarcarPago;
window.resConfirmarPago    = resConfirmarPago;
window.resFecharModal      = resFecharModal;
window.resExcluir          = resExcluir;
window.resAbrirImport      = resAbrirImport;
window.resOnZipFile        = resOnZipFile;
window.resAtribuirOrfao    = resAtribuirOrfao;
window.resConfirmarImport  = resConfirmarImport;
...
window.renderParceiros        = renderParceiros;
window.importParceirosFile    = importParceirosFile;
window.onParceirosFileChange  = onParceirosFileChange;
window.toggleParceirosValues  = toggleParceirosValues;
window.startEditParceiroLogo  = startEditParceiroLogo;
window.onParceiroLogoChange   = onParceiroLogoChange;
window.enterParceirosTop      = enterParceirosTop;
window.exitParceirosTop       = exitParceirosTop;
window.setParceirosTopN       = setParceirosTopN;
window.toggleParceirosTopValues = toggleParceirosTopValues;
...
window.renderResiduos     = renderResiduos;
